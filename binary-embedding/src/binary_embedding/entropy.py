...
class EntropyFilter:
    ...
    def __init__(
        self,
        entropy_bins: Optional[list[float]] = None,
    ...
    def should_sample(self, data: bytes, random_value: Optional[float] = None) -> bool:
    ...
    def get_entropy_stats(self, data: bytes) -> dict:
        ...
        return {
            ...
            "bin_range": (
                ...
                self.entropy_bins[bin_idx + 1] if bin_idx < len(self.entropy_bins) - 1 else float('inf')
            ),
